...
let s:bwc.lessbrightgravel   = ['b2b2b2', 250] " sustainablelab
...
" let s:bwc.darkgravel     = ['242321', 234] " sustainablelab
...
" call s:HL('Normal', 'lessbrightgravel', 'darkgravel')
call s:HL('Normal', 'lessbrightgravel', 'blackgravel')

call s:HL('Folded', 'mediumgravel', 'bg', 'none')

call s:HL('VertSplit', 'lightgravel', 'bg', 'none')

call s:HL('QuickFixLine', 'dress', 'darkgravel', 'none') " sustainablelab
call s:HL('CursorLine',   '', 'darkgravel', 'none')
" call s:HL('CursorLine',   '', 'deepergravel', 'none') " sustainablelab
" call s:HL('CursorLine',   '', 'blackestgravel', 'none') " sustainablelab
" call s:HL('CursorColumn', '', 'gravel')
call s:HL('CursorColumn', '', 'darkgravel')
" call s:HL('CursorColumn', '', 'deepergravel') " sustainablelab
" call s:HL('CursorColumn', '', 'blackestgravel') " sustainablelab
" call s:HL('ColorColumn',  '', 'darkgravel')
call s:HL('ColorColumn',  '', 'blackestgravel') " sustainablelab
...
" call s:HL('Search',    'coal', 'dress', 'bold')
" call s:HL('Search',    'darkgravel', 'dress', 'bold')
